...
#to_do fix last not player reciving get name message
# fix players getting message to input a letter at improper time(when it is not their turn)
# polish chars encodeing
...
def announce_start(clients) -> None:
    ...
    broadcast('The game will start in 30s! No players can join\r\n', clients)
...
def server_logic():
    ...
    game_start_thread = threading.Thread(target=start_game_delay_seconds, args = (start_game, 10))
